...
public interface MemberCacheService {
    ...
    */
    List<MemberResponseDto.CheckResponse> putMemberInCacheIfEmpty(MemberRequestCacheDTO.BasicInfo basicInfo);

    List<MemberResponseDto.CheckResponse> getRoomOfMemberList(String roomCode);

    List<MemberResponseDto.CheckResponse> leaveMemberInCache(MemberRequestCacheDTO.BasicInfo basicInfo);
